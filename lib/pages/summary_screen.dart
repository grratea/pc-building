...
class SummaryScreenState extends State<SummaryScreen> {
  ...
  Future<void> loadConfiguration() async {
    ...
    if (configId == null) {
      await loadComponentsFromCurrentConfig(config);
      return;
    }
    ...
    await loadComponents(componentTypes);
  }

  Future<void> loadComponentsFromCurrentConfig(Configuration config) async {
    final componentTypes = {
      'CPU': config.cpuId,
      'GPU': config.gpuId,
  ...
  Future<void> loadComponents(Map<String, String?> componentTypes) async {
  ...
  Future<void> _saveConfiguration() async {
    ...
    try {
      ...
      configProvider.resetConfiguration();
